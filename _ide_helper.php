 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \Qruto\Flora\FloraServiceProvider::packageBooted()
         * @param string $environment
         * @param callable $callback
         * @static 
         */ 
        public static function install($environment, $callback)
        {
                        return \Illuminate\Foundation\Application::install($environment, $callback);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function update($environment, $callback)
        {
                        return \Illuminate\Foundation\Application::update($environment, $callback);
        }
...
')
     ...
     *
     */ 
        class rConfigActivityLogArchive {
     ...
     *
     */ 
        class rConfigReportLastDownload {
     ...
     *
     */ 
        class ContinueSupervisorCommand {
