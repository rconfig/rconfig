...
class TaskDownloadDeviceHasDevices implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        if ($this->task_command === 'rconfig:download-device' && empty($value)) {
            $fail('The ' . $this->commandLookupTable($this->task_command) . ' task type must have devices associated with it. Please select at least one device.');
        }
