                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                        <img src="{!! url('/images/artwork_blue_horizontal_Artboard_1_72px.png'); !!}" alt="rConfig Logo" title="rConfig Logo" style="display: block;  margin-left: auto; margin-right: auto; padding-bottom: 15px;"/>
                                                ...
                                                <thead
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th
                                                            ...
                                                            Description</th>
                                                        <th
                                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; border-bottom: 1px solid #edeff2; padding-bottom: 8px; text-align: right;">
                                                            Price</th>
                                                    </tr>
                                                </thead>
                                                <tbody
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            Lorem Ipsum</td>
                                                        <td
                                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 18px; padding: 10px 0; text-align: right;">
                                                            $10</td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="#" class="button"
                                                                                target="_blank"
                                                                                style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); color: #ffffff; display: inline-block; text-decoration: none; -webkit-text-size-adjust: none; background-color: #2d3748;  border-top: 10px solid #3097d1; border-right: 18px solid #3097d1; border-bottom: 10px solid #3097d1; border-left: 18px solid #3097d1;">Blue
                                                                                button</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                        ...
                                        <table class="promotion" align="center" width="100%" cellpadding="0"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                    <p
                                                        style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; line-height: 1.5em; margin-top: 0; font-size: 15px; text-align: center;">
