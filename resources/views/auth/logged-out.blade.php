...
@section('content')
    <div id="logout-loading-container" class="flex items-center justify-center h-screen ">
        <loggout-loading></loggout-loading>
    </div>

    <div id="logout-main-content" class="hidden bg-black" style="background: radial-gradient(ellipse 80% 60% at 50% 0%, rgba(226, 232, 240, 0.15), transparent 70%), #000000">
