            ...
            <div class="pf-c-login__main-body">
                <form novalidate class="pf-c-form" action="{{ route('login') }}" method="POST">
                    ...
                    <p class="pf-c-form__helper-text pf-m-error ">
                        ...
                        </span>{{ __('auth.invalid_login_cred') }}</p>
                    @enderror
                    <div class="pf-c-form__group">
                        ...
                        <input class="pf-c-form-control" input="true" type="text" id="username" value="{{ old('username') }}"
                            name="username" required autocomplete="username" autofocus @error('username') aria-invalid='true'
                            @enderror />
                        @error('username')
                    ...
                    <div class="pf-c-form__group">
                        ...
                        <input class="pf-c-form-control" required input="true" type="password" id="password"
                    ...
                    <div class="pf-c-form__group">
                        <div class="pf-c-check">
                            <input class="pf-c-check__input" type="checkbox" type="checkbox" id="remember"
                    ...
                    <div class="pf-c-form__group pf-m-action">
                        <button class="pf-c-button pf-m-primary pf-m-block"
                            type="submit">{{ __('generic.log_in') }}</button>
                    </div>
                </form>
            </div>
