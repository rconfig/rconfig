    ...
    <form novalidate class="pf-c-form">
        ...
        <div class="pf-l-grid pf-m-gutter">
            <div class="pf-l-grid__item pf-m-3-col">
                <div class="pf-c-form__group">
                    ...
                    <div class="pf-c-form__group-control">
                        <input
                            ...
                            autocomplete="off"
                        />
                        <p v-if="errors.fileName" class="pf-c-form__helper-text pf-m-error" id="form-help-text-address-helper" aria-live="polite">
                            {{ errors.fileName[0] }}
                        </p>
                        <p v-if="showSelectTemplateFields" class="pf-c-form__helper-text">You may overwrite this filename if a template was selected</p>
                    </div>
                </div>
                <button
                ...
                <div class="pf-c-form__group pf-u-mt-lg" v-if="showSelectTemplateFields">
                    ...
                    <div class="pf-c-select pf-m-expanded" ref="clickOutsidetarget1">
                        ...
                        <button class="pf-c-select__toggle" type="button" @click.prevent="showVendorTemplateOptions = !showVendorTemplateOptions">
                            <div class="pf-c-select__toggle-wrapper">
                                <span class="pf-c-select__toggle-text" v-text="vendorTemplateOptionSelected.length != 0 ? vendorTemplateOptionSelected : 'Choose a vendor'"></span>
                            </div>
                            ...
                            <ul class="pf-c-select__menu multi-select-dropdown-overflow" role="listbox">
                                <li role="presentation" v-for="option in vendorTemplateOptions.data" :key="option.name">
                                    <button class="pf-c-select__menu-item" role="option" @click.prevent="getTemplatesList(option)">
                                        {{ option.name }}
                                        <span class="pf-c-select__menu-item-icon" v-if="option.name === vendorTemplateOptionSelected">
                ...
                <div class="pf-c-form__group pf-u-mt-sm" v-if="showSelectTemplateFields && hasListedFiles">
                    ...
                    <div class="pf-c-select pf-m-expanded" ref="clickOutsidetarget2">
                        <span hidden>Choose an option</span>
                        <button class="pf-c-select__toggle" type="button" @click.prevent="showFileOptions = !showFileOptions">
                            <div class="pf-c-select__toggle-wrapper">
                                <span class="pf-c-select__toggle-text" v-text="fileOptionSelected.length != 0 ? fileOptionSelected : 'Choose a vendor'"></span>
                            </div>
                            <span class="pf-c-select__toggle-arrow">
                                <i class="fas fa-caret-down" aria-hidden="true"></i>
                            </span>
            ...
            <div class="pf-c-form__group pf-l-grid__item pf-m-9-col">
                ...
                <div class="pf-c-tooltip pf-m-top-left" role="tooltip" v-if="copied" style="z-index: 999; position: absolute; top: 26%">
                    ...
                    <div class="pf-c-code-editor">
                        <div class="pf-c-code-editor__header">
                            <div class="pf-c-code-editor__controls">
                                ...
                                <button class="pf-c-button pf-m-control" type="button" title="Download code" alt="Download code" @click="download(model.fileName)">
                                    <i class="fas fa-download"></i>
                                </button>
                                <button class="pf-c-button pf-m-control" type="button" title="full screen" alt="full screen" @click="showConfigFullScreen">
