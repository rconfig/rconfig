      ...
      <div class="pf-l-grid__item pf-m-3-col">
        <div class="pf-c-form__group">
          ...
          <div class="pf-c-form__group-control">
            ...
            <p v-if="showSelectTemplateFields" class="pf-c-form__helper-text">
        ...
        >
          ...
          <div class="pf-c-select pf-m-expanded" ref="clickOutsidetarget1">
            ...
            <button
              ...
              type="button"
              @click.prevent="
                showVendorTemplateOptions = !showVendorTemplateOptions
              "
            >
              <div class="pf-c-select__toggle-wrapper">
                <span
                  ...
                  v-text="
                    vendorTemplateOptionSelected.length != 0
          ...
          <p class="pf-c-form__helper-text">
            Select a vendor first, then select a template below
          </p>
        </div>
        <div
        ...
        >
              ...
              >
                ...
                >
                  <button
                    class="pf-c-select__menu-item"
                    role="option"
                    @click.prevent="getFileContents(option)"
                  >
                    {{ option.name }}
                    <span
                      class="pf-c-select__menu-item-icon"
          ...
          <p class="pf-c-form__helper-text pf-u-warning-color-100">
            Warning: Selecting a template will instantly overwrite any edits in
            the yaml file
          </p>
        </div>
            ...
            <div class="pf-c-code-editor__header">
              <div class="pf-c-code-editor__controls">
                ...
                <div class="pf-c-check" style="align-content: center">
                  ...
                  <label class="pf-c-check__label" style="cursor: default"
                    >Dark Mode</label
                  >
                </div>
                <div class="pf-c-check" style="align-content: center">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    onClickOutside(
      clickOutsidetarget1,
      (event) => (showVendorTemplateOptions.value = false)
    );
    onClickOutside(
      clickOutsidetarget2,
      (event) => (showFileOptions.value = false)
    );
      ...
      axios
        ...
        .catch((error) => {
          meditor.updateOptions({
            value:
              "Something went wrong - could not retrieve the default template from the file system!",
          });
          createNotification({
            type: "danger",
            title: "Error",
    ...
    function showTemplate() {
      axios
        ...
        .catch((error) => {
          meditor.updateOptions({
            value:
              "Something went wrong - could not retrieve the template from the file system!",
          });
          createNotification({
            type: "danger",
            title: "Error",
    ...
    function getTemplatesList(vendorOption) {
      ...
      axios
        .post("/api/list-repo-folders-contents", {
          directory: vendorOption.path,
        })
        .then((response) => {
