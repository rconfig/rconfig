...
export const useNotificationStore = defineStore("notifications", () => {
	...
	const loadFallbackEnums = () => {
		const { categories, channels: configChannels, types } = notificationConfig.notifications;
		...
		enums.value = {
			categories: [
				...
				{
					key: "connection",
					label: categories.connection.label,
					description: categories.connection.description,
					icon: "Wifi",
				},
				{
					key: "task",
			...
			channels: [
				{
					key: "db",
					label: configChannels.db.label,
					description: configChannels.db.description,
					icon: "Database",
					color: "blue",
				},
				{
					key: "mail",
					label: configChannels.mail.label,
					description: configChannels.mail.description,
					icon: "Mail",
					color: "green",
				},
			],
			types: [
				// System
				{
					...
					category: "system",
					label: types.system_notification_error.label,
					description: types.system_notification_error.description,
					severity: "info",
					channels: ["db", "mail"],
				},
				// Config
				{
					...
					category: "config",
					label: types.config_download_completed.label,
					description: types.config_download_completed.description,
					severity: "info",
					channels: ["db", "mail"],
				},
				{
					...
					category: "config",
					label: types.config_purge_completed.label,
					description: types.config_purge_completed.description,
					severity: "info",
					channels: ["db", "mail"],
				},
				{
					...
					category: "config",
					label: types.config_purge_failed_completed.label,
					description: types.config_purge_failed_completed.description,
					severity: "info",
					channels: ["db", "mail"],
				},
				{
					key: "config.changed",
					category: "config",
					label: types.config_changed.label,
					description: types.config_changed.description,
					severity: "info",
					channels: ["db", "mail"],
				},
				// Connection
				{
					...
					category: "connection",
					label: types.connection_device_failure.label,
					description: types.connection_device_failure.description,
					severity: "warning",
					channels: ["db", "mail"],
				},
				// Task
				{
					key: "task.completed",
					category: "task",
					label: types.task_completed.label,
					description: types.task_completed.description,
					severity: "info",
					channels: ["db", "mail"],
				},
				{
					...
					category: "task",
					label: types.task_download_report.label,
					description: types.task_download_report.description,
					severity: "info",
					channels: ["db", "mail"],
				},
			],
