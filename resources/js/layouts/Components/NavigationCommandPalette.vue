...
const navigationItems = computed(() => [
	...
	{
		id: "device-snmp",
		label: t("snmpproperties"),
		icon: "snmp",
		route: "/devices-snmp",
		group: "Inventory",
	},
	{
		id: "device-configprops",
		label: t("configprops"),
		icon: "configprop",
		route: "/devices-configprops",
		group: "Inventory",
	},
	{
		id: "api-collections",
		label: t("apicollections"),
		icon: "api-collection",
	...
	},
	{
		...
		label: t("complianceAssignments"),
		icon: "compliance-assignment",
		route: "/policy-assignments",
		group: "Compliance",
	},
	{
		id: "policy-definitions",
		label: t("complianceDefinitions"),
		icon: "compliance-definition",
		route: "/policy-definitions",
		group: "Compliance",
	},
	{
		id: "cic-definitions",
		label: t("cicDefinitions"),
		icon: "cic",
		route: "/cic-definitions",
		group: "Compliance",
	},
	...
	{
		id: "integrations",
		label: t("common.entities.integrations"),
		icon: "integrations",
	...
	{
		id: "agents",
		label: t("common.entities.agents"),
		icon: "vector-agent",
	...
	{
		id: "snmp-traps",
		label: t("common.entities.snmptraps"),
		icon: "snmp",
		route: "/network-services/snmp-traps",
		group: "Network Services",
	},
	{
		id: "xftp",
		label: t("common.entities.xftp"),
		icon: "xftp",
		route: "/network-services/xftp",
		group: "Network Services",
	},
	{
		id: "system-settings",
