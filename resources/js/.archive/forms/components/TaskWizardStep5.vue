<template>
  <div class="pf-c-wizard__main-body">
    ...
    <div
      v-else
      class="pf-u-pt-sm">
      <task-verify-progress
        :status="progressCheckStatus"
        @verificationDone="verificationDone = true"></task-verify-progress>

      <div
        v-if="verificationDone && errors"
        class="pf-u-pt-md">
        <p
      ...
      <!-- FINAL RESULTS DIV -->
      <task-final-result-output
        v-if="verificationDone && !errors"
        :model="model"></task-final-result-output>
    </div>
  </div>
</template>
