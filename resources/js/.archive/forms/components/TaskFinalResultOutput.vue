<template>
  <dl class="pf-c-description-list pf-m-horizontal pf-u-pt-md">
    ...
    <div
      ...
      v-if="model.device || model.category || model.tag">
      <dt class="pf-c-description-list__term">
        <span class="pf-c-description-list__text">Task Configuration</span>
      </dt>
      <dd class="pf-c-description-list__description">
        <div class="pf-c-description-list__text">
          <task-final-result-output-chip-group-devices
            v-if="model.device"
            :model="model"></task-final-result-output-chip-group-devices>
          <task-final-result-output-chip-group-categories
            v-if="model.category"
            :model="model"></task-final-result-output-chip-group-categories>
          <task-final-result-output-chip-group-tags
            v-if="model.tag"
            :model="model"></task-final-result-output-chip-group-tags>
        </div>
      </dd>
    </div>
    <div class="pf-c-description-list__group">
