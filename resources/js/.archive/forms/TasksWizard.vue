      ...
      <div class="pf-c-wizard__header">
        ...
        <p
          ...
          <span v-if="wizard.selectedTask.id > 0">
            :
            <span class="pf-u-default-color-100">{{ wizard.selectedTask.categoryLabel }} - {{ wizard.selectedTask.label }}</span>
          </span>
        </p>
      </div>
      <button
        ...
        <span class="pf-c-wizard__toggle-list">
          <span class="pf-c-wizard__toggle-list-item">
            <span class="pf-c-wizard__toggle-num">1</span>
            Task Type
          </span>
        </span>
      ...
      <div class="pf-c-wizard__outer-wrap">
        <div class="pf-c-wizard__inner-wrap">
          <nav
            ...
            aria-label="Basic wizard steps">
            <ol class="pf-c-wizard__nav-list">
              <li class="pf-c-wizard__nav-item">
                <button
                  class="pf-c-wizard__nav-link"
                  :class="{ 'pf-m-current': wizard.currentPage === 1 }"
              ...
              <li class="pf-c-wizard__nav-item">
                <button
                  class="pf-c-wizard__nav-link"
                  :class="{ 'pf-m-current': wizard.currentPage === 2 }"
              ...
              <li class="pf-c-wizard__nav-item">
                <button
                  class="pf-c-wizard__nav-link"
                  :class="{ 'pf-m-current': wizard.currentPage === 3 }"
              ...
              <li class="pf-c-wizard__nav-item">
                <button
                  class="pf-c-wizard__nav-link"
                  :class="{ 'pf-m-current': wizard.currentPage === 4 }"
                  @click.prevent="setPage(4)">
                  Task Schedule
                </button>
              </li>
              <li class="pf-c-wizard__nav-item">
                <button
                  class="pf-c-wizard__nav-link"
                  :class="{ 'pf-m-current': wizard.currentPage === 5 }"
                  @click.prevent="setPage(5)">
                  Review
                </button>
              </li>
            </ol>
          ...
          <div
            class="pf-c-alert pf-m-danger pf-m-inline taskWizardAlert"
          ...
          <div
            aria-label="Basic wizard content"
            class="pf-c-wizard__main"
            v-if="wizard.currentPage === 1">
            <task-wizard-step-1
              :wizardData="wizard"
              @selectTask="setSelectedTask($event)"></task-wizard-step-1>
          </div>
          <div
            aria-label="Basic wizard content"
            class="pf-c-wizard__main"
            v-if="wizard.currentPage === 2">
            <task-wizard-step-2
              :wizardData="wizard"
              :model="model"></task-wizard-step-2>
          </div>
          <div
            aria-label="Basic wizard content"
            class="pf-c-wizard__main"
            v-if="wizard.currentPage === 3">
            <task-wizard-step-3
              :wizardData="wizard"
              :model="model"></task-wizard-step-3>
          </div>
          <div
            aria-label="Basic wizard content"
            class="pf-c-wizard__main"
            v-if="wizard.currentPage === 4">
            <task-wizard-step-4
              :wizardData="wizard"
              :model="model"></task-wizard-step-4>
          </div>
          <div
            aria-label="Basic wizard content"
            class="pf-c-wizard__main"
            v-if="wizard.currentPage === 5">
            <task-wizard-step-5
              :wizardData="wizard"
              :model="model"></task-wizard-step-5>
          </div>
        </div>
        <footer class="pf-c-wizard__footer">
          <button
            class="pf-c-button pf-m-secondary"
            :class="{ ' pf-m-disabled': wizard.currentPage === 1 }"
            :disabled="wizard.currentPage === 1"
            type="button"
