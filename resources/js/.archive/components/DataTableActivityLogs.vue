      ...
      <div class="pf-c-card">
        ...
        <table
            ...
            <tr role="row">
              ...
              <td
                ...
                <span class="pf-c-button__icon pf-m-start">
                  <i
                    v-if="header.key === 'log_name'"
                    :class="activityLogIconTable[data.log_name]"></i>
                </span>
          ...
          <data-table-empty-state
            v-if="tabledata.data.data && Object.keys(tabledata.data.data).length < 1"
        ...
        <data-table-paginate
          ...
          v-if="!tabledata.isLoading"></data-table-paginate>
      </div>
    </div>
  </div>
</template>
...
import useCreateResizableColumn from '../.archive/composables/createResizableColumn';
