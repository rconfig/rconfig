    ...
    <div class="pf-c-drawer__body pf-m-padding">
      <div class="pf-c-card">
        <devices-data-table-toolbar
          ...
          :newBtnEnabled="newBtnEnabled"></devices-data-table-toolbar>
            ...
            <tr
              ...
              <td
                ...
                <div v-else>
                  <div v-if="header.isStatusIcon">
                    <span
                      v-if="data.job_status != null"
                      class="pf-u-default-color-300 pf-u-text-wrap">
                      {{ data.job_status }}...
                    </span>
                    <i
                      v-else
                  ...
                  <span v-else>
                    ...
                    <span v-else-if="header.key === 'tag'">
                      <div
                        class="pf-c-chip"
                        v-for="tag in data[header.key]"
                        :key="tag.id">
                        <span
                          class="pf-c-chip__text"
                          :alt="tag.tagDescription"
              ...
              <td
                ...
                <div>
                  ...
                  <button
                    class="pf-c-button pf-m-link pf-m-link-secondary pf-m-small"
                    type="button"
                    @click="openDrawer(data.id, true)"
                    alt="Clone"
                    title="Clone">
                    <span class="pf-c-button__icon pf-m-start">
                      <i
