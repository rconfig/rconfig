        ...
        <div class="pf-c-drawer__main">
          ...
          <div class="pf-c-drawer__content pf-m-no-background">
            <div class="pf-c-drawer__body pf-m-padding">
                  ...
                  <form
                    ...
                    <label
                      ...
                      <span
                        ...
                        id="search_latest_only-on"
                        aria-hidden="true">
                        Search latest only on
                      </span>

                      <span
                        class="pf-c-switch__label pf-m-off"
                        id="search_latest_only-off"
                        aria-hidden="true">
                        Search latest only off
                      </span>
                    </label>
              ...
              <div
                class="pf-c-card pf-u-mt-lg"
                id="summary_card"
                v-if="results.search_results && Object.keys(results.search_results).length > 0">
                    ...
                    <div
                      ...
                      <div class="pf-l-grid pf-m-gutter pf-u-mb-md">
                        <div class="pf-l-grid__item pf-m-3-col copyLinkDD">
                          <b>Device Name:</b>
                          <span>{{ result[0][4] }}</span>
                          <button
                            class="pf-c-button pf-m-inline pf-m-link pf-u-color-100 copyLink"
                            type="button"
                            alt="copy"
                            title="copy"
                            @click="copy(result[0][4])">
                            <copy-icon></copy-icon>
                          </button>
                        </div>
                        <div class="pf-l-grid__item pf-m-3-col copyLinkDD">
                          <b>Category:</b>
                          <span>{{ result[0][5] }}</span>
                          <button
                            class="pf-c-button pf-m-inline pf-m-link pf-u-color-100 copyLink"
                            type="button"
                            alt="copy"
                            title="copy"
                            @click="copy(result[0][5])">
                            <copy-icon></copy-icon>
                          </button>
                        </div>
                        <div class="pf-l-grid__item pf-m-3-col copyLinkDD">
                          <b>Date:</b>
                          <span>{{ result[0][1] }} {{ result[0][2] }} {{ result[0][3] }}</span>
                          <button
                            class="pf-c-button pf-m-inline pf-m-link pf-u-color-100 copyLink"
                            type="button"
                            alt="copy"
                      ...
                      <div>
                        <button
                          ...
                          aria-expanded="false"
                          @click="toggleExpandResults(result)">
                          ...
                          <span class="pf-c-expandable-section__toggle-text">
                            <span v-if="!result['expanded']">Show</span>
                            <span v-if="result['expanded']">Hide</span>
                            search results
                          </span>
                        </button>
                        <div
                          class="pf-c-expandable-section__content"
                          :hidden="!result['expanded']">
              ...
              <div
                ...
                v-if="results.matchCount > 0 && showScrollBtn">
                <button
                  class="pf-c-button pf-m-primary"
                  @click="scrollToTop">
                  Back to top
...
import useScrollToBottom from '../.archive/composables/scrollToBottom';
