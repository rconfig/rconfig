<template>
  <main
    ...
    <page-header :pagename="viewstate.pagename">
      <template v-slot:breadcrumbs>
        <devices-breadcrumbs
          :devicename="configModel.device_name"
          :deviceId="configModel.device_id"></devices-breadcrumbs>
      </template>
    </page-header>
    <div
      class="pf-c-divider"
              ...
              <div
                ...
                <div class="pf-l-grid__item pf-m-12-col pf-m-9-col-on-md">
                  <monaco-code-panel
                    ...
                    @showConfigFullScreen="showConfigFullScreen($event)"></monaco-code-panel>
                </div>
              </div>
              <div
  ...
  <config-full-screen-view
    ...
    :language="viewstate.modelObject.language"></config-full-screen-view>
</template>
