    ...
    <page-header :pagename="pagename">
      <template v-slot:breadcrumbs>
        <devices-breadcrumbs
          ...
          :deviceId="deviceid"></devices-breadcrumbs>
      </template>
    </page-header>
    <div
      class="pf-c-divider"
      ...
      <div
        ...
        <div class="pf-c-drawer__main">
          <data-table-configs
            ...
            :rowsDeleteNotification="rowsDeleteNotification"></data-table-configs>
        </div>
      </div>
    </section>
  </main>
...
import useModels from '../../.archive/composables/ModelsFactory';
