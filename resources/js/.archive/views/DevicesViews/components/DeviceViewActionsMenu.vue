                ...
                <div class="pf-c-menu__content">
                    <ul class="pf-c-menu__list">
                        <li class="pf-c-menu__list-item">
                            <button class="pf-c-menu__item" type="button" @click="copyDebug('cd ' + appDirPath + ' && php artisan rconfig:download-device ' + model.id + ' -d')">
                        ...
                        <li class="pf-c-menu__list-item">
                            ...
                            >
                                <span class="pf-c-menu__item-main">
                                    <span class="pf-c-menu__item-icon">
                                        <i class="pficon pf-icon-storage-domain" aria-hidden="true"></i>
                                    </span>
                        ...
                        <li class="pf-c-menu__list-item">
                            <button class="pf-c-menu__item" @click="downloadNow()">
                                <span class="pf-c-menu__item-main">
                                    <span class="pf-c-menu__item-icon">
                                        <i class="pficon pf-icon-save" aria-hidden="true"></i>
                                    </span>
                                    <span class="pf-c-menu__item-text">Download now</span>
                                </span>
                                <span class="pf-c-menu__item-description pf-u-text-break-word" style="word-wrap: normal">Start a download for this device</span>
                            </button>
                        </li>

                        <li class="pf-c-menu__list-item" v-if="downloadStatus" style="cursor: auto">
                            <button class="pf-c-menu__item">
                                <span class="pf-c-menu__item-main">
                                    <span class="pf-c-menu__item-icon">
                                        ...
                                        <i class="fa fa-check-circle pf-u-success-color-100" aria-hidden="true" v-if="downloadStatus === 'The job finished, check configs and logs for details.'"></i>
                                        <i class="fa fa-exclamation-circle pf-u-danger-color-100" aria-hidden="true" v-if="downloadStatus === 'Failed'"></i>
                                    </span>
                                    <span class="pf-c-menu__item-text">Download status</span>
                                </span>
                                <span class="pf-c-menu__item-description pf-u-text-break-word" style="word-wrap: normal">{{ downloadStatus }}</span>
                            </button>
                        </li>

                        <li class="pf-c-menu__list-item">
                            <button class="pf-c-menu__item" @click="openDrawer(model.id, true)">
                                <span class="pf-c-menu__item-main">
                                    <span class="pf-c-menu__item-icon">
                                ...
                                <span class="pf-c-menu__item-description pf-u-text-break-word" style="word-wrap: normal">Create a new device with similar configuration</span>
                            </button>
                        </li>

                        <li class="pf-c-menu__list-item">
                            <button class="pf-c-menu__item" @click="purgeFailedConfigs()">
                                <span class="pf-c-menu__item-main">
                                    <span class="pf-c-menu__item-icon">
                                ...
                                <span class="pf-c-menu__item-description pf-u-text-break-word" style="word-wrap: normal">Purge all Failed Configs for this device</span>
                            </button>
                        </li>
                    </ul>
                </div>
