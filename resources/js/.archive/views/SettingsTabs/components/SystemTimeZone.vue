          ...
          <div class="pf-c-form__group">
            ...
            <div class="pf-c-form__group-control">
              <timezone-select
                ...
                @timezoneSetSuccess="timezoneUpdated($event)"></timezone-select>
            </div>
          </div>
          <div
            ...
            <div class="pf-c-form__group-control">
              <div class="pf-c-form__actions">
                <helper-default-text
                  :show="timezoneSuccess.isDefault"
                  :message="'Current system timezone is set to ' + timezone"></helper-default-text>

                <helper-success-text
                  :show="timezoneSuccess.isSuccess"
                  :message="timezoneSuccess.successMsg"
                  :key="2"></helper-success-text>
              </div>
            </div>
          </div>
        </form>
