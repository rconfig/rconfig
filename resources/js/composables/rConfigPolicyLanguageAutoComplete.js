...
export default function userConfigPolicyLanguageAutoComplete(monaco) {
	return [
		...
		{
			label: "must_not_match_regex",
			kind: monaco.languages.CompletionItemKind.Text,
			insertText: "[must_not_match_regex]",
		},
		{
		...
		{
			label: "wildcard_must_not_match_single_string",
			kind: monaco.languages.CompletionItemKind.Text,
			insertText: "[wildcard_must_not_match_single_string]",
		},
		{
		...
		{
			label: "match_code_block_flexible",
			kind: monaco.languages.CompletionItemKind.Text,
			insertText: "[match_code_block_flexible]",
		},
	];
}
