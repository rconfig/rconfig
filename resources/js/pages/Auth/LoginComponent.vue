		...
		<CardContent>
			...
			<form @submit.prevent="handleLogin">
				<div class="grid gap-4">
					...
					<!-- Divider -->
					<div
						v-if="Object.values(socialProviders).some(Boolean)"
						class="relative my-4"
					>
					...
					<div class="grid gap-3">
						<a
							v-if="socialProviders.microsoft"
						...
						<a
							v-if="socialProviders.okta"
							href="/auth/redirect/okta"
							class="group w-full inline-flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/70 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 backdrop-blur-sm"
						>
							<svg
								class="mr-3 h-5 w-5 flex-shrink-0"
							...
							>
								<path
									fill="#007dc1"
									d="M8 0C3.582 0 0 3.582 0 8s3.582 8 8 8 8-3.582 8-8S12.418 0 8 0zm0 12c-2.209 0-4-1.791-4-4s1.791-4 4-4 4 1.791 4 4-1.791 4-4 4z"
								/>
							</svg>
						...
						<a
							v-if="socialProviders.saml2"
							href="/auth/redirect/saml2"
							class="group w-full inline-flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/70 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 backdrop-blur-sm"
						>
