						...
						<dl class="grid gap-3">
							...
							<div class="flex items-center justify-between">
								...
								<dd class="flex items-center gap-2">
									...
									<RcToolTip
										v-if="configData.device_name && configData.device_name.length > 15"
										:delay-duration="100"
										:content="configData.device_name"
										:side="'bottom'"
									>
										<template #trigger>
											<Lightbulb
							...
							<div class="flex items-center justify-between">
								...
								<dd class="flex items-center gap-2">
									...
									<RcToolTip
										v-if="configData.command && configData.command.length > 15"
										:delay-duration="100"
										:content="configData.command"
										:side="'bottom'"
									>
										<template #trigger>
											<Lightbulb
							...
							<div class="flex items-center justify-between">
								...
								<dd class="flex items-center gap-2">
									...
									<RcToolTip
										v-if="configData.config_filename && configData.config_filename.length > 15"
										:delay-duration="100"
										:content="configData.config_filename"
										:side="'bottom'"
									>
										<template #trigger>
											<Lightbulb
							...
							<div class="flex items-center justify-between">
								...
								<dd class="flex items-center gap-2">
									{{ formatters.formatFileSize(configData.config_filesize) }}
								</dd>
							</div>
							<div class="flex items-center justify-between">
								<dt class="text-muted-foreground">
								...
								<dd class="flex items-center gap-2">
									{{ formatters.formatDuration(configData.start_time, configData.end_time) }}
								</dd>
							</div>
							<div class="flex items-center justify-between">
								<dt class="text-muted-foreground">
								...
								<dd class="flex items-center gap-2">
									{{ formatters.formatTime(configData.created_at) }}
								</dd>
							</div>
						</dl>
					</div>
