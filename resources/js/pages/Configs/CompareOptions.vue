...
<template>
	...
	>
					...
					<div class="pb-4 px-4">
						...
						<div class="space-y-6">
							...
							<div class="flex justify-end pt-6 space-x-2">
								...
								<Button
									type="submit"
									class="px-2 py-1 text-sm hover:animate-pulse btn-primary-action flex items-center justify-between"
									size="sm"
									variant="default"
					...
					<div class="flex flex-col">
						<div class="flex items-center p-2">
							...
							<div class="gap-1 flex items-center">
								...
								<RcToolTip
									:delay-duration="100"
									:content="'Download Exclusion File'"
									:side="'bottom'"
								>
									<template #trigger>
										<Button
											variant="ghost"
											class="px-2 py-1 rc-btn-shadow"
											@click="download('config-compare-exclusions.txt')"
										>
											<RcIcon
		...
		<RcConfirmAlertDialog
			...
			description="This will reset all compare settings to their default values. This only takes effect when you click Update, and the exclusion code in the editor will not change."
