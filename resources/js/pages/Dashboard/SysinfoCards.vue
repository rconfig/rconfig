		...
		<div class="border-0 shadow-md rounded-2xl bg-card text-card-foreground p-4 transition-all duration-200 hover:shadow-lg h-fit">
			<div class="flex items-center justify-between mb-3">
				...
				>
					<RcIcon
						name="refresh"
						size="16"
						:class="isLoadingSysinfo ? 'animate-spin' : ''"
					/>
				</button>
			</div>
			...
			>
				<div class="flex justify-between items-center py-1">
					...
					<div class="flex items-center gap-2">
						...
						<Button
							class="h-6 p-1 ml-auto text-muted-foreground"
							variant="ghost"
							title="copy raw data"
						...
						>
							<RcIcon
								...
								:is-active="activeCopyIcon['OSVersion']"
								:size="16"
							/>
						</Button>
					</div>
				...
				<div class="flex justify-between items-center py-1">
					...
					<div class="flex items-center gap-2">
						...
						>
							<RcIcon
								name="copy-transition"
								:is-active="activeCopyIcon['ServerName']"
								:size="16"
							/>
						</Button>
					</div>
				...
				<div class="flex justify-between items-center py-1">
					...
					<div class="flex items-center gap-2">
						...
						>
							<RcIcon
								name="copy-transition"
								:is-active="activeCopyIcon['localIp']"
								:size="16"
							/>
						</Button>
					</div>
				...
				<div class="flex justify-between items-center py-1">
					...
					<div class="flex items-center gap-2">
						...
						<Button
							...
							variant="ghost"
							title="copy raw data"
							@click="copyItem('PHPVersion', sysinfo.PHPVersion?.split(' / ')[0])"
						>
							<RcIcon
								name="copy-transition"
								:is-active="activeCopyIcon['PHPVersion']"
								:size="16"
							/>
						</Button>
					</div>
				...
				<div class="flex justify-between items-center py-1">
					...
					<div class="flex items-center gap-2">
						...
						>
							<RcIcon
								name="copy-transition"
								:is-active="activeCopyIcon['MySQLVersion']"
								:size="16"
							/>
						</Button>
					</div>
			...
			<div class="mt-4 pt-3 border-t border-muted/50 text-xs text-muted-foreground flex items-center justify-between">
				<div class="flex items-center gap-2">
					...
					<div
						v-else
						class="h-3 bg-muted rounded w-20 animate-pulse"
					></div>
				</div>
				...
				<HoverCard>
					...
					<HoverCardContent
						class="w-80 bg-gradient-to-r from-card/80 via-card/60 to-card/80 backdrop-blur-md shadow-sm"
						side="top"
						align="end"
					>
						<div class="space-y-3">
							...
							<div class="grid grid-cols-1 gap-2 text-xs">
								...
								<div class="flex justify-between items-center py-1">
									...
									<a
										:href="sysinfo.url"
										target="_blank"
										class="text-right text-blue-500 hover:text-blue-600 underline text-xs break-all"
									>
										{{ sysinfo.url || "Loading..." }}
									</a>
								</div>
