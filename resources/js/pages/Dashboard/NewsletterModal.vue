				...
				<div class="grid gap-2.5">
					<div class="flex items-start gap-3 p-2.5 rounded-xl bg-muted/30 hover:bg-muted/50 transition-colors group">
						...
						<div class="flex-1 min-w-0">
							...
							<p class="text-xs text-muted-foreground leading-snug">
								Be first to know about new features and improvements
							</p>
						</div>
					</div>
					...
					<div class="flex items-start gap-3 p-2.5 rounded-xl bg-muted/30 hover:bg-muted/50 transition-colors group">
						...
						<div class="flex-1 min-w-0">
							...
							<p class="text-xs text-muted-foreground leading-snug">
								Expert tips for network automation and configuration management
							</p>
						</div>
					</div>
					...
					<div class="flex items-start gap-3 p-2.5 rounded-xl bg-muted/30 hover:bg-muted/50 transition-colors group">
						...
						<div class="flex-1 min-w-0">
							...
							<p class="text-xs text-muted-foreground leading-snug">
								Tutorials, case studies, and industry insights
							</p>
						</div>
					</div>
				</div>
