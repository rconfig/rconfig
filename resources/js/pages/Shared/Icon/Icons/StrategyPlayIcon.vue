	...
	<div class="animated-icon-container">
		...
		>
			...
			>
				<polygon
					id="x-left-poly"
					:fill="currentColor"
					points="12 3.415 10.586 2 7 5.587 3.414 2 2 3.415 5.586 7 2 10.586 3.414 12 7 8.414 10.586 12 12 10.586 8.414 7 12 3.415"
				/>
			</g>
			<path
				id="path-element"
			...
			>
				<polygon
					id="x-right-poly"
					:fill="currentColor"
					points="30 21.415 28.586 20 25 23.587 21.414 20 20 21.415 23.586 25 20 28.586 21.414 30 25 26.414 28.586 30 30 28.586 26.414 25 30 21.415"
				/>
			</g>
			<rect
				fill="none"
		...
		>
			...
			<input
				...
				type="color"
				@input="$emit('update:color', currentColor)"
			/>
		</div>
	</div>
</template>
