	...
	<Popover>
		<PopoverTrigger class="col-span-3">
			<Button
				...
				:class="selectedSnmpOids.length === 0 ? 'text-muted-foreground' : ' '"
				:style="selectedSnmpOids.length === 0 ? 'padding: 0.45rem' : 'padding: 0.2rem'"
			>
				...
				>
					<span class="flex items-center text-xs font-medium me-2 px-2.5 py-0.5 rounded-xl border">
						...
						<X
							...
							@click.stop="deleteItemById(oid.id)"
						/>
					</span>
				</span>
			</Button>
