...
<template>
	<div class="flex items-center justify-center text-sm">
		<div class="animated-logo-container">
			<svg
				class="animated-logo"
				:class="{ 'replay-animation': shouldReplay }"
				viewBox="0 0 1350 386.34"
			...
			>
				...
				<g class="icon-group">
					<path
						class="logo-path"
						d="M88.72,332.63v-2.27c-.95-11.92,3.26-34.13,25.04-45.86,19.76-10.64,24.43-13.2,24.49-13.23l.36-.19s11.04-6.06,11.04-16.02v-57.58c-11.02,6.52-58.37,34.51-76.36,44.2-11.55,6.22-10.37,18.93-10.36,19.06l.08,1.45v55.59l25.71,14.84Z"
					/>
					<path
						class="logo-path"
						d="M116.73,328.45l.12.91-.06.36v19.11l32.91,19v-70.85c-2.89,1.57-9.39,5.09-22.63,12.22-11.02,5.93-10.44,17.9-10.34,19.24Z"
					/>
					<path
						class="logo-path"
						d="M254.08,199.41c-18-9.69-65.34-37.68-76.36-44.2v59.23c0,9.94,10.93,15.96,11.04,16.02l.36.19c.06.03,4.73,2.59,24.49,13.23,21.78,11.73,25.99,33.94,25.04,45.86v44.18l25.71-14.84v-100.06l.08-.53c.08-1.16.66-13.13-10.35-19.06Z"
					/>
					<path
						class="logo-path"
						d="M210.59,288.18l.07-.53c.09-1.16.66-13.13-10.35-19.06-13.11-7.06-19.6-10.57-22.54-12.17v112.64s.02,0,.02-.01l32.8-18.93v-61.93Z"
					/>
					<path
						class="logo-path"
				...
				<g class="text-group">
					...
					<path
						class="logo-path"
						d="M474.17,111.43h4.97v23.73h-9.38c-14.73,0-26.04,3.91-33.96,11.74-7.91,7.82-11.87,19.09-11.87,33.81v79.77h-26.49V113.08h20.98v44.35c1.88-13.33,6.23-23.68,13.11-30.96,9.48-10.03,23.69-15.04,42.65-15.04Z"
					/>
					<!-- C -->
					<path
						class="logo-path"
					...
					<path
						class="logo-path"
						d="M965.22,108.66h-1.1c-12.33,0-22.54,2.62-30.64,7.86-8.1,5.25-14.12,12.89-18.08,22.91-1,2.54-1.87,5.22-2.62,8.05v-34.41h-20.98v147.4h26.49v-88.05c0-11.96,3.6-21.52,10.77-28.7,7.18-7.18,16.57-10.77,28.16-10.77s20.05,3.45,26.5,10.36c6.43,6.9,9.66,16.05,9.66,27.46v89.71h26.5v-84.19c0-21.9-4.46-38.64-13.39-50.24-8.93-11.59-22.69-17.38-41.27-17.38Z"
					/>
					<!-- F -->
					<path
						class="logo-path"
						d="M1065.97,67.81c-8.65,7.73-12.97,19.78-12.97,36.16v9.11h-20.43v19.87h20.43v127.53h25.39v-127.53h39.47v-19.87h-39.47v-13.52c0-6.62,1.84-11.83,5.52-15.6,3.68-3.77,8.92-5.66,15.73-5.66h20.98v-22.08h-16.56c-16.75,0-29.45,3.86-38.09,11.59Z"
					/>
					<!-- I (dot and stem) -->
					<g>
						<path
							class="logo-path"
							d="M1161.75,89.34c5.88,0,10.25-1.56,13.11-4.69,2.85-3.12,4.28-7.08,4.28-11.87s-1.43-8.74-4.28-11.87c-2.86-3.12-7.22-4.69-13.11-4.69s-10.26,1.57-13.11,4.69c-2.86,3.13-4.28,7.09-4.28,11.87s1.42,8.75,4.28,11.87c2.85,3.13,7.22,4.69,13.11,4.69Z"
						/>
						<polygon
							class="logo-path"
							points="1154.3,113.08 1132.77,113.08 1132.77,134.05 1154.3,134.05 1154.3,260.48 1180.8,260.48 1180.8,134.05 1180.8,113.08 1154.3,113.08"
						/>
					</g>
					<!-- G -->
					<path
