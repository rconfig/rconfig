...
const props = defineProps({
	message: {
		type: String,
		default: "Warning alert! Please review this information.",
	},
	heading: {
		type: String,
		default: "Warning!",
	...
	bgColor: {
		type: String,
		default: "bg-yellow-50 dark:bg-gray-800",
	},
	textColor: {
		type: String,
	...
	gradientFrom: {
		type: String,
		default: "from-yellow-50", // Light mode start color
	},
	gradientTo: {
		type: String,
	...
	darkGradientFrom: {
		type: String,
		default: "dark:from-yellow-900/50", // Dark mode start color
	},
	show: {
		type: Boolean,
		default: false,
