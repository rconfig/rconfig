...
const props = defineProps({
	message: {
		type: String,
		default: "Pro tip! Here's a helpful suggestion to improve your workflow.",
	},
	heading: {
		type: String,
		default: "Tip!",
	...
	bgColor: {
		type: String,
		default: "bg-indigo-50 dark:bg-gray-800",
	},
	textColor: {
		type: String,
		default: "text-indigo-800 dark:text-indigo-300",
	},
	useGradient: {
		type: Boolean,
		default: false,
	...
	gradientFrom: {
		type: String,
		default: "from-indigo-50", // Light mode start color
	},
	gradientTo: {
		type: String,
	...
	darkGradientFrom: {
		type: String,
		default: "dark:from-indigo-900/50", // Dark mode start color
	},
	show: {
		type: Boolean,
		default: false,
