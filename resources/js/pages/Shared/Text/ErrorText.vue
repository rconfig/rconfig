...
const props = defineProps({
	message: {
		type: String,
		default: "Error alert! Operation failed.",
	},
	heading: {
		type: String,
		default: "Error!",
	...
	delay: {
		type: Number,
		default: 0, // Changed from 1000 to 0
	},
	bgColor: {
		type: String,
		default: "bg-red-50 dark:bg-gray-800",
	},
	textColor: {
		type: String,
		default: "text-red-800 dark:text-red-400",
	},
	useGradient: {
		type: Boolean,
		default: false,
	...
	gradientFrom: {
		type: String,
		default: "from-red-50", // Light mode start color
	},
	gradientTo: {
		type: String,
	...
	darkGradientFrom: {
		type: String,
		default: "dark:from-red-900/50", // Dark mode start color
	},
	show: {
		type: Boolean,
		default: false,
