...
const props = defineProps({
	message: {
		type: String,
		default: "Success alert! Operation completed successfully.",
	},
	heading: {
		type: String,
		default: "Success!",
	...
	bgColor: {
		type: String,
		default: "bg-green-50 dark:bg-gray-800",
	},
	textColor: {
		type: String,
		default: "text-green-800 dark:text-green-400",
	},
	useGradient: {
		type: Boolean,
		default: false,
	...
	gradientFrom: {
		type: String,
		default: "from-green-50", // Light mode start color
	},
	gradientTo: {
		type: String,
	...
	darkGradientFrom: {
		type: String,
		default: "dark:from-green-900/50", // Dark mode start color
	},
	show: {
		type: Boolean,
		default: false,
