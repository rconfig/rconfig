...
<template>
	<div class="flex flex-col sm:flex-row items-start sm:items-center justify-between py-4 space-y-4 sm:space-y-0">
			...
			>
				<DropdownMenuGroup>
					<DropdownMenuItem
						class="group"
						:disabled="isLoading"
						@click="handlePerPageChange(5)"
					>
						<span class="flex items-center gap-2">
							<RcIcon
								name="pin"
								:class="perPage === 5 ? 'text-blue-300' : 'text-rcgray-400'"
					...
					<DropdownMenuItem
						class="group"
						:disabled="isLoading"
						@click="handlePerPageChange(10)"
					>
						<span class="flex items-center gap-2">
							<RcIcon
								name="pin"
								:class="perPage === 10 ? 'text-blue-300' : 'text-rcgray-400'"
								class="group-hover:text-blue-300"
							/>
							10 per page
						</span>
					...
					<DropdownMenuItem
						class="group"
						:disabled="isLoading"
						@click="handlePerPageChange(20)"
					>
						<span class="flex items-center gap-2">
							<RcIcon
								name="pin"
								:class="perPage === 20 ? 'text-blue-300' : 'text-rcgray-400'"
								class="group-hover:text-blue-300"
							/>
							20 per page
						</span>
					...
					<DropdownMenuItem
						class="group"
						:disabled="isLoading"
						@click="handlePerPageChange(50)"
					>
						<span class="flex items-center gap-2">
							<RcIcon
								name="pin"
								:class="perPage === 50 ? 'text-blue-300' : 'text-rcgray-400'"
								class="group-hover:text-blue-300"
							/>
							50 per page
						</span>
					...
					<DropdownMenuItem
						class="group"
						:disabled="isLoading"
						@click="handlePerPageChange(10000000)"
					>
						<span class="flex items-center gap-2">
							<RcIcon
								name="pin"
								:class="perPage === 10000000 ? 'text-blue-300' : 'text-rcgray-400'"
								class="group-hover:text-blue-300"
							/>
							All
						</span>
		...
		<div
			v-if="totalRecords !== undefined"
			class="text-sm text-muted-foreground text-center flex-1 sm:flex-initial"
		>
			<div class="flex flex-col sm:flex-row sm:items-center sm:justify-center sm:space-x-4">
				<span class="hidden sm:inline">
					<Skeleton
						v-if="isLoading"
						class="h-4 w-24 rounded mx-auto"
					/>
				...
				<span class="sm:hidden">
					<Skeleton
						v-if="isLoading"
						class="h-4 w-16 rounded mx-auto"
					/>
...
@click="goToStart"
			...
			<Button
				...
				variant="outline"
				size="sm"
				class="py-1 flex-1 sm:flex-none"
