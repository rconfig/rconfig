		...
		>
			<div class="max-h-[25vh] min-h-0 flex flex-col">
				...
				<div
					...
					aria-hidden="true"
					class="w-full h-px flex-none bg-[rgba(244,245,246,0.04)] transition-opacity duration-[140ms] opacity-1 data-[visible='false']:opacity-0"
				></div>
				<div class="flex flex-none flex-row items-center justify-between gap-2 p-[4px_8px_8px_12px]">
						...
						>
							...
							>
								<Icon
									...
									class="text-sm text-muted-foreground hover:text-white"
								></Icon>
							</div>
						</button>
					</div>
					...
					>
						<div class="inline-block overflow-hidden text-sm font-medium leading-5 tracking-tight align-bottom text-ellipsis whitespace-nowrap text-gray-50">
							Comment
						</div>
					</button>
					<button
