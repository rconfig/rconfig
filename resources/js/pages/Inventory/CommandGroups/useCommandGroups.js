...
export function useCommandGroups() {
	...
	const perPage = ref(pageSettings.get("useCommandGroups", "perPage", 10));
	...
	const { reload } = useReload(fetchCommandGroups);
	const { toggleSort } = useToggleSort(sortParam, fetchCommandGroups, "useCommandGroups");
	...
	watch(perPage, (newVal) => {
		pageSettings.set("useCommandGroups", "perPage", perPage.value);
		fetchCommandGroups();
	});
