...
const systemManagementIsOpen = ref(
  JSON.parse(localStorage.getItem("sidebarSystemManagementIsOpen")) ?? true,
);
const securityAccessIsOpen = ref(
  JSON.parse(localStorage.getItem("sidebarSecurityAccessIsOpen")) ?? true,
);
const dataManagementIsOpen = ref(
  JSON.parse(localStorage.getItem("sidebarDataManagementIsOpen")) ?? true,
);
const monitoringDebuggingIsOpen = ref(
  JSON.parse(localStorage.getItem("sidebarMonitoringDebuggingIsOpen")) ?? true,
);
const infoIsOpen = ref(
  JSON.parse(localStorage.getItem("sidebarInfoIsOpen")) ?? true,
);
...
watch(monitoringDebuggingIsOpen, (newVal) => {
  localStorage.setItem(
    "sidebarMonitoringDebuggingIsOpen",
