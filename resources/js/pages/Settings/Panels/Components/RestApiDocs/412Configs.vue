...
const pagename = "Configs V2";

const endpoints = {
  0: {
    name: "Config",
    description: "Get configs (paginated) with optional filters",
    method: "get",
    url: "/api/v2/configs",
    parameters: [
      {
        name: "filter[download_status]",
      ...
      },
      {
        ...
        description: "optional|string (LIKE)",
        type: "string",
        example: "router1",
      },
      {
      ...
      },
      {
        ...
        type: "comma-separated fields",
        example: "id,device_id,command,created_at",
      },
      {
        name: "includeConfig",
        description: "optional|boolean",
    ...
    responses: {
      ...
      data: [
        {
          ...
          report_id: null,
          config_location:
            "/var/www/html/rconfig8/storage/app/rconfig/data/Routers/router1/2022/Mar/18/showclock_646.txt",
          config_filename: "showclock_646.txt",
          config_filesize: 33,
          start_time: "2022-03-18 06:46:06",
          end_time: "2022-03-18 06:46:07",
          duration: 1,
          created_at: "2022-03-18 06:46:06",
          updated_at: "2022-03-18 06:46:07",
        },
        {
          id: 2,
          device_id: 1001,
          ...
          report_id: null,
          config_location:
            "/var/www/html/rconfig8/storage/app/rconfig/data/Routers/router1/2022/Mar/18/showversion_646.txt",
          config_filename: "showversion_646.txt",
      ...
      first_page_url: "https://rconfig.example/api/v2/configs?page=1",
      from: 1,
      last_page: 5,
      last_page_url: "https://rconfig.example/api/v2/configs?page=5",
      next_page_url: "https://rconfig.example/api/v2/configs?page=2",
      path: "https://rconfig.example/api/v2/configs",
      per_page: 10,
      prev_page_url: null,
      to: 2,
      total: 45,
    ...
    responsesdescription:
      "Successful response. Returns paginated configs. When includeConfig=true, each item also includes a config field with the file contents.",
  },
  1: {
    name: "Config",
    description:
      "Get a single config, with metadata and the actual configuration data",
    method: "get",
    url: "/api/v2/configs/{id}",
    parameters: [
      {
        name: "id",
    ...
    parametersdescription:
      "Pass ID integer value in the URL per above. Use includeConfig=true to include the config contents.",
    responses: {
      id: 2,
      device_id: 1001,
      device_name: "router1",
  ...
  2: {
    ...
    responsesdescription:
      "Successful response. Deletes the config record and its file.",
  },
  3: {
    name: "Config",
    description: "Get config status count",
    method: "get",
    url: "/api/v2/configs/status/{deviceid}/{status}",
    parameters: [
      {
        name: "deviceid",
        description: "required",
      ...
      },
      {
        name: "status",
        description: "required",
        type: "failed|success|unknown|all",
        example: "success",
      },
    ],
    parametersUrlOnly: true,
    parametersdescription:
      "Use status values: failed, success, unknown, or all.",
    responses: {
      success: true,
      data: {
        count: 32,
      },
      message: "Config status count for device ID 123444 with status 1",
    },
    responsesdescription:
      "Successful response. Returns the count of configs matching the status and device.",
  },
  4: {
    name: "Config",
    description:
...
<template>
  <CardHeader>
    ...
    <CardDescription
      >Manage and analyze device configurations through the REST
      API</CardDescription
    >
  </CardHeader>
  ...
  <div class="px-6 pb-4">
    <div class="flex items-start gap-2 mb-6">
      ...
      <div>
        <h3 class="text-base font-medium">Working with Configuration Files</h3>
        <p class="text-muted-foreground mt-1">
          The Configs API allows you to access, download, compare, and search
          through device configuration files that have been collected by
          rConfig. These operations help you understand your network state and
