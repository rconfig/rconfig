...
<template>
	...
	<CardContent>
		<div class="space-y-6">
			...
			>
				<TabsList>
					<TabsTrigger value="token-auth">
						Token Authentication
					</TabsTrigger>
					<TabsTrigger value="header-format">
						Example Requests
					</TabsTrigger>
							...
							>
								...
								>
									<RcIcon
										...
										:is-active="activeCopyIcon['urlExample']"
										:size="16"
									/>
								</Button>
							</div>
						...
						<div>
							...
							>
								...
								>
									<RcIcon
										name="copy-transition"
										:is-active="activeCopyIcon['headerExample']"
										:size="16"
									/>
								</Button>
							</div>
				...
				>
					...
					>
						...
						>
							<RcIcon
								name="copy-transition"
								:is-active="activeCopyIcon['jsExample']"
								:size="16"
							/>
						</Button>
					</div>
			...
			<div class="border-t pt-6">
				...
				<ul class="space-y-3">
					<li class="flex items-start gap-2">
						...
						<p class="text-muted-foreground">
							<span class="text-foreground font-medium">Store tokens securely:</span>
					...
					<li class="flex items-start gap-2">
						<CheckCircle class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
						<p class="text-muted-foreground">
							<span class="text-foreground font-medium">Use environment variables:</span>
					...
					<li class="flex items-start gap-2">
						<CheckCircle class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
						<p class="text-muted-foreground">
							<span class="text-foreground font-medium">Rotate tokens regularly:</span>
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
					...
					>
						<div class="flex flex-col items-start">
							...
							<span class="text-sm text-muted-foreground">Introduction to the rConfig API</span>
						</div>
					</Button>
					<Button
						variant="outline"
					...
					>
						<div class="flex flex-col items-start">
							...
							<span class="text-sm text-muted-foreground">How to test API endpoints</span>
						</div>
					</Button>
				</div>
			</div>
