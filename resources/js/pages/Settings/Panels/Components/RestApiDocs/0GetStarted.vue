  ...
  <CardContent>
    <div class="space-y-6">
      <div class="flex items-start gap-2">
        ...
        <div>
          <h3 class="text-base font-medium">API Overview</h3>
      ...
      <div class="flex items-start gap-2">
        <CheckCircle class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
        <div>
          <h3 class="text-base font-medium">Base URL</h3>
          <p class="text-muted-foreground mt-1">
      ...
      <div class="border-t pt-6">
        <h3 class="text-lg font-medium mb-2">New Endpoint in API v2</h3>
        ...
        <router-link to="/settings/restapi-docs/dashboard/health-latest-v2">
          <Button variant="outline" size="sm"
            >Open Dashboard Health Latest v2 Docs</Button
          >
        </router-link>
      </div>

      <div class="border-t pt-6">
        <h3 class="text-lg font-medium mb-2">Pagination Behavior (v2)</h3>
      ...
      <div class="border-t pt-6">
        <h3 class="text-lg font-medium mb-4">API Versioning</h3>
        ...
        <Tabs v-model="activeTab" class="w-full mt-4">
          ...
          <TabsContent value="overview" class="space-y-4 mt-4">
            <h4 class="font-medium">Using the API</h4>
            <p class="text-muted-foreground">
          ...
          <TabsContent value="versioning" class="mt-4">
            <div class="space-y-4">
              <div>
                <h4 class="font-medium">Version History</h4>
                <ul class="mt-2 space-y-3">
                  <li class="flex items-start gap-2">
                    <RcBadge variant="outline">v1</RcBadge>
                    <span class="text-muted-foreground"
                      >Initial API release (Current)</span
                    >
                  </li>
                  <li class="flex items-start gap-2">
                    <RcBadge variant="outline">v2</RcBadge>
                    <span class="text-muted-foreground"
                      >Beta - New endpoints for devices and configs</span
                    >
                  </li>
                </ul>
              </div>
          ...
          <TabsContent value="changelog" class="mt-4">
            <div class="space-y-4">
              <div>
                <h4 class="font-medium">v1.2.0 (Current)</h4>
              ...
              <div>
                <h4 class="font-medium">v1.1.0</h4>
                <ul class="list-disc ml-5 mt-2 space-y-1 text-muted-foreground">
                  <li>Added bulk operations for devices</li>
                </ul>
              </div>
              <div>
                <h4 class="font-medium">v1.0.0</h4>
                <ul class="list-disc ml-5 mt-2 space-y-1 text-muted-foreground">
      ...
      <div class="border-t pt-6">
        <h3 class="text-lg font-medium mb-4">Example Request</h3>
        <p class="text-muted-foreground mb-4">
