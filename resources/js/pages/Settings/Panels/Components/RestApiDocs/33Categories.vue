...
const endpoints = {
  0: {
      ...
      data: [
        {
          ...
          categoryDescription: "Core Network Routers",
        ...
        },
        {
          ...
          categoryDescription: "Network Switches",
          badgeColor: "badge-info",
          created_at: "Jun 06, 2018 22:21PM",
          updated_at: "Jan 01, 1970 1:00AM",
          devices: [
            {
              id: 1003,
    ...
    responsesdescription:
      "Successful response. Note: a category comes with the devices relationship by default.",
  },
  1: {
    name: "Category",
  ...
  2: {
    ...
    parameters: [
      {
        name: "categoryName",
        description: "required|unique:categories|max:255|min:2|alpha_dash",
        type: "string",
        example: "Firewalls",
      },
      {
...
<template>
  <CardHeader>
    ...
    <CardDescription
      >Manage device categories through the rConfig API</CardDescription
    >
  </CardHeader>

  <div class="px-6 pb-4">
    <div class="flex items-start gap-2 mb-6">
      <FolderTree class="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
      <div>
        <h3 class="text-base font-medium">Categories Overview</h3>
        <p class="text-muted-foreground mt-1">
          Manage device categories through the rConfig API
        </p>
      </div>
    </div>
    ...
    <AlertInfo
      ...
      message="Categories have relationships with devices. When retrieving categories, the associated devices are included in the response."
    />
  </div>
