...
<template>
	<CardHeader>
		...
		<CardDescription>
			Learn how to test rConfig API endpoints effectively
		</CardDescription>
	</CardHeader>
					...
					>
						...
						>
							...
							>
								<RcIcon
									name="copy-transition"
									:is-active="activeCopyIcon['browser']"
									:size="16"
								/>
							</Button>
						</div>
				...
				<div class="space-y-4">
					...
					>
						...
						<div class="p-4">
							...
							<h4 class="text-sm font-medium mt-3 mb-2">
								Example Request:
							</h4>
                  ...
                  endpoint.curlExample
								...
								>
									<RcIcon
										name="copy-transition"
										:is-active="activeCopyIcon['curlExample2' + index]"
										:size="16"
									/>
								</Button>
							</div>
