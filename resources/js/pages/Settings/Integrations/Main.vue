	...
	<div class="pb-16 pl-10 space-y-6 md:block">
		<div class="space-y-0.5">
			...
			<p class="text-muted-foreground">
				Setup integrations with systems for security and credentials
			</p>
		</div>
					...
					>
						...
						<div class="w-3/4">
							...
							<div class="flex items-center gap-2 mt-2 text-xs text-muted-foreground">
								...
								/>
								<a
									:href="$rconfigDocsUrl + '/integrations/sso/sso-overview/'"
									target="_blank"
										...
										>
											<div class="flex items-center">
												<div class="flex-shrink-0">
													<component
														:is="integration.iconComponent"
														v-if="integration.iconComponent"
														class="w-6 h-6"
													/>
												</div>
												<div class="ml-2 flex items-center justify-between w-full">
													...
													<div class="flex items-center justify-end w-full">
														<Button
															...
															:disabled="isLoading"
															@click="openLink(integration)"
														>
															Configure
															<span
																v-if="integration.external_url === 1"
																class="ml-1.5"
															>
														...
														<RcIcon
															v-if="isIntegrationConfigured(integration)"
															name="status-green"
															class="w-6 h-6 ml-2"
														/>
