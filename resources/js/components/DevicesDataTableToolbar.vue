    ...
    <div class="pf-c-toolbar">
        <div class="pf-c-toolbar__content">
            <div class="pf-c-toolbar__content-section pf-m-nowrap">
                ...
                <div class="pf-c-toolbar__group pf-m-filter-group pf-m-hidden pf-m-visible-on-lg">
                    <div class="pf-c-toolbar__item">
                        <div class="pf-c-select pf-m-expanded" ref="clickOutsidetarget1">
                            ...
                            <button class="pf-c-select__toggle" type="button" aria-haspopup="true" aria-expanded="false" @click.prevent="showCatFilteroptions = !showCatFilteroptions">
                                <div class="pf-c-select__toggle-wrapper">
                                    <span class="pf-c-select__toggle-text" v-text="selectedCatName ? selectedCatName : 'Categories'"></span>
                                </div>
                                <span class="pf-c-select__toggle-arrow">
                                    <i class="fas fa-caret-down" aria-hidden="true"></i>
                                </span>
                            </button>
                            <ul class="pf-c-select__menu" role="listbox" v-if="showCatFilteroptions ? 'hidden' : ''">
                                <li role="presentation" v-for="option in cats" :key="option">
                                    <button class="pf-c-select__menu-item pf-m-selected" role="option" @click.prevent="setFilter('category', option.id, option.categoryName)">
                                        {{ option.categoryName }}
                                        <span class="pf-c-select__menu-item-icon" v-if="selectedCatName === option.categoryName">
                    ...
                    <div class="pf-c-toolbar__item">
                        <div class="pf-c-select pf-m-expanded" ref="clickOutsidetarget2">
                            ...
                            <button class="pf-c-select__toggle" type="button" aria-haspopup="true" aria-expanded="false" @click.prevent="showTagFilteroptions = !showTagFilteroptions">
                                <div class="pf-c-select__toggle-wrapper">
                                    <span class="pf-c-select__toggle-text" v-text="selectedTagname ? selectedTagname : 'Tag'"></span>
                                </div>
                                <span class="pf-c-select__toggle-arrow">
                                    <i class="fas fa-caret-down" aria-hidden="true"></i>
                                </span>
                            </button>
                            <ul class="pf-c-select__menu" role="listbox" v-if="showTagFilteroptions ? 'hidden' : ''">
                                <li role="presentation" v-for="option in tags" :key="option">
                                    <button class="pf-c-select__menu-item pf-m-selected" role="option" @click.prevent="setFilter('tag', option.id, option.tagname)">
                                        {{ option.tagname }}
                                        <span class="pf-c-select__menu-item-icon" v-if="selectedTagname === option.tagname">
                                            <i class="fas fa-check" aria-hidden="true"></i>
                                        </span>
                                    </button>
                                </li>
                    ...
                    <div class="pf-c-toolbar__item">
                        <div class="pf-c-select pf-m-expanded" ref="clickOutsidetarget3">
                            ...
                            <button class="pf-c-select__toggle" type="button" aria-haspopup="true" aria-expanded="false" @click.prevent="showVendorFilteroptions = !showVendorFilteroptions">
                                <div class="pf-c-select__toggle-wrapper">
                                    <span class="pf-c-select__toggle-text" v-text="selectedVendorname ? selectedVendorname : 'Vendor'"></span>
                                </div>
                                <span class="pf-c-select__toggle-arrow">
                                    <i class="fas fa-caret-down" aria-hidden="true"></i>
                                </span>
                            </button>
                            <ul class="pf-c-select__menu" role="listbox" v-if="showVendorFilteroptions ? 'hidden' : ''">
                                <li role="presentation" v-for="option in vendors" :key="option">
                                    <button class="pf-c-select__menu-item pf-m-selected" role="option" @click.prevent="setFilter('vendor', option.id, option.vendorName)">
                                        {{ option.vendorName }}
                                        <span class="pf-c-select__menu-item-icon" v-if="selectedVendorname === option.vendorName">
                                            <i class="fas fa-check" aria-hidden="true"></i>
                                        </span>
                                    </button>
                                </li>
                    ...
                    <div class="pf-c-toolbar__item">
                        <div class="pf-c-select pf-m-expanded" ref="clickOutsidetarget4">
                            ...
                            <button class="pf-c-select__toggle" type="button" aria-haspopup="true" aria-expanded="false" @click.prevent="showModelFilteroptions = !showModelFilteroptions">
                                <div class="pf-c-select__toggle-wrapper">
                                    <span class="pf-c-select__toggle-text" v-text="selectedModelname ? selectedModelname : 'Model'"></span>
                                </div>
                                <span class="pf-c-select__toggle-arrow">
                                    <i class="fas fa-caret-down" aria-hidden="true"></i>
                                </span>
                            </button>
                            <ul class="pf-c-select__menu" role="listbox" v-if="showModelFilteroptions ? 'hidden' : ''">
                                <li role="presentation" v-for="option in models" :key="option">
                                    <button class="pf-c-select__menu-item pf-m-selected" role="option" @click.prevent="setFilter('device_model', option, option)">
                                        {{ option }}
                                        <span class="pf-c-select__menu-item-icon" v-if="selectedModelname === option">
                                            <i class="fas fa-check" aria-hidden="true"></i>
                                        </span>
                                    </button>
                                </li>
                ...
                <button class="pf-c-button pf-m-control" type="button" alt="Edit Columns" title="Edit Columns" @click="showEditColumns()">
                ...
                <div class="pf-c-toolbar__group pf-m-icon-button-group">
                    <div class="pf-c-toolbar__item">
                        <button class="pf-c-button pf-m-plain" type="button" @click.prevent="clear()">
                            <i class="fas fa-expand-arrows-alt" :class="activeStatus === null ? 'statusActive' : 'statusInactive'" alt="Show all devices" title="Show all devices"></i>
                        </button>
                    </div>
                    <div class="pf-c-toolbar__item">
                        <button class="pf-c-button pf-m-plain" type="button" @click.prevent="filterSelect('status', '1')">
                            <i class="fas fa-check-circle pf-u-success-color-100" :class="activeStatus == '1' ? 'statusActive' : 'statusInactive'" alt="Show up devices" title="Show up devices"></i>
                        </button>
                    </div>
                    <div class="pf-c-toolbar__item">
                        <button class="pf-c-button pf-m-plain" type="button" @click.prevent="filterSelect('status', '0')">
                            <i
        ...
        <!-- FILTER CHIPS -->
        <div class="pf-c-toolbar__content pf-m-chip-container" v-if="selectedCatName || selectedModelname || selectedVendorname || selectedTagname">
                            ...
                            <ul class="pf-c-chip-group__list" role="list">
                                <li class="pf-c-chip-group__list-item" v-if="selectedCatName">
                                    <div class="pf-c-chip">
                                        ...
                                        <button class="pf-c-button pf-m-plain" type="button" @click="clear()">
                                ...
                                <li class="pf-c-chip-group__list-item" v-if="selectedVendorname">
                                    <div class="pf-c-chip">
            ...
            <div class="pf-c-toolbar__item">
                <button class="pf-c-button pf-m-link pf-m-inline" type="button" @click="clear()">Clear all filters</button>
            </div>
        </div>
        <!-- FILTER CHIPS -->
    </div>
