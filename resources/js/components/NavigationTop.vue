<template>
    <header class="pf-c-page__header">
        ...
        <div class="pf-c-page__header-tools">
            <div class="pf-c-page__header-tools-group">
                ...
                <div class="pf-c-page__header-tools-item pf-m-hidden pf-m-visible-on-lg" alt="settings" title="settings">
                    <router-link tag="button" class="pf-c-button pf-m-plain" to="/settings/overview" exact>
                        <i class="fas fa-cog" aria-hidden="true"></i>
                    </router-link>
                </div>

                <div class="pf-c-page__header-tools-item pf-m-hidden pf-m-visible-on-lg" alt="help" title="help">
                    <button class="pf-c-button pf-m-plain" type="button" aria-label="Help" @click="showAboutModal = true">
                        <i class="pf-icon pf-icon-help" aria-hidden="true"></i>
                    </button>
                </div>
                <div class="pf-c-page__header-tools-item pf-m-hidden pf-m-visible-on-lg" alt="logout" title="logout">
                    <a href="" @click.prevent="logout()">
                        <button class="pf-c-button pf-m-plain" type="button" aria-label="Sign out">
            ...
            <div class="pf-c-page__header-tools-group">
                <div class="pf-c-page__header-tools-item pf-m-hidden pf-m-visible-on-md">
                    <div class="pf-c-dropdown">
                        <router-link tag="button" class="pf-c-dropdown__toggle pf-m-plain" :to="'/settings/users/' + $userId" id="primary-detail-panel-body-padding-dropdown-button">{{
                            $userName
                        }}</router-link>
                    </div>
                </div>
    ...
    <modal-about v-if="showAboutModal" @close="showAboutModal = false"></modal-about>
</template>
