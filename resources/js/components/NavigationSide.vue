...
<template>
  <div class="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
    <div class="bg-muted/40 md:block bg-gray-100 dark:bg-rcgray-800">
      <div class="flex h-full max-h-screen flex-col gap-2">
        <div class="relative flex items-center justify-between w-full max-w-full p-2 border-b border-rcgray-600">
          <div class="flex items-center">
            ...
            <div class="ml-2 font-semibold text-md">rConfig</div>
          </div>
          <div class="mt-2 mr-6">
            <button
