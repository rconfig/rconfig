...
const routes = [
  ...
  { path: '/device/view/configs/:id', component: () => import('@/pages/Configs/Main.vue'), props: true },
  { path: '/device/view/configs/view-config/:id', component: () => import('@/pages/Configs/Main.vue') },
