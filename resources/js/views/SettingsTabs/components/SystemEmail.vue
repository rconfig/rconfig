                ...
                <form novalidate="" class="pf-c-form pf-m-horizontal">
                    <div class="pf-c-form__group">
                        ...
                        <div class="pf-c-form__group-control">
                            <input
                                ...
                                tabindex="1"
                            />
                            <p v-if="emailSettings.errors.mail_host" class="pf-c-form__helper-text pf-m-error" id="form-help-text-address-helper" aria-live="polite">
                    ...
                    <div class="pf-c-form__group">
                        ...
                        <div class="pf-c-form__group-control">
                            <input
                                ...
                                tabindex="1"
                            />
                            <p v-if="emailSettings.errors.mail_port" class="pf-c-form__helper-text pf-m-error" id="form-help-text-address-helper" aria-live="polite">
                    ...
                    <div class="pf-c-form__group">
                        ...
                        <div class="pf-c-form__group-control">
                            <input
                                ...
                                tabindex="2"
                            />
                            <p v-if="emailSettings.errors.mail_from_email" class="pf-c-form__helper-text pf-m-error" id="form-help-text-address-helper" aria-live="polite">
                    ...
                    <div class="pf-c-form__group">
                        <div class="pf-c-form__group-label" style="position: relative">
                            ...
                            <button class="pf-c-form__group-label-help" @mouseover="mailToTooltip = true" @mouseleave="mailToTooltip = false" tabindex="-1">
                                <i class="pficon pf-icon-help" aria-hidden="true"></i>
                            </button>
                            <div class="pf-c-tooltip pf-m-bottom" role="tooltip" v-if="mailToTooltip" style="position: absolute">
                                <div class="pf-c-tooltip__arrow"></div>
                                <div class="pf-c-tooltip__content" id="tooltip-top-content">Enter multiple emails separated by a semi-colon (;)</div>
                            </div>
                        </div>
                        <div class="pf-c-form__group-control">
                            <input
                                ...
                                tabindex="3"
                            />
                            <p v-if="emailSettings.errors.mail_to_email" class="pf-c-form__helper-text pf-m-error" id="form-help-text-address-helper" aria-live="polite">
                        ...
                        <div class="pf-c-form__group-control">
                            <label class="pf-c-switch" style="margin-top: 20px">
                                <input
                                    ...
                                    tabindex="4"
                                />
                                <p v-if="emailSettings.errors.mail_authcheck" class="pf-c-form__helper-text pf-m-error" id="form-help-text-address-helper" aria-live="polite">
                                    {{ emailSettings.errors.mail_authcheck[0] }}
                                </p>

                                <span class="pf-c-switch__toggle"></span>

                                <span class="pf-c-switch__label pf-m-on" id="mail_authcheck-on" aria-hidden="true">Authentication enabled</span>

                                <span class="pf-c-switch__label pf-m-off" id="mail_authcheck-off" aria-hidden="true">Authentication disabled</span>
                            </label>
                        </div>
                    </div>
                    <div class="pf-c-form__group" v-if="settings.mail_authcheck">
                        ...
                        <div class="pf-c-form__group-control">
                            <div class="pf-c-select pf-m-expanded">
                                ...
                                <button class="pf-c-select__toggle" type="button" @click="showEncrytionOptions = !showEncrytionOptions" tabindex="5">
                                    <div class="pf-c-select__toggle-wrapper">
                                        <span
                                            class="pf-c-select__toggle-text"
                                            v-text="settings.mail_encryption ? settings.mail_encryption.toUpperCase() : 'Choose an option'"
                                        ></span>
                                    </div>
                                ...
                                <div v-if="showEncrytionOptions ? 'hidden' : ''">
                                    <ul class="pf-c-select__menu" role="listbox" aria-labelledby="select-single-expanded-label" tabindex="6">
                                        <li role="presentation">
                                            <button class="pf-c-select__menu-item" role="option" @click="selectEncryption('tls')">
                                                TLS
                                                <span class="pf-c-select__menu-item-icon" v-if="settings.mail_encryption === 'tls'">
                                                    <i class="fas fa-check" aria-hidden="true"></i>
                                                </span>
                                            </button>
                                        </li>
                                        <li role="presentation">
                                            <button class="pf-c-select__menu-item" role="option" @click="selectEncryption('ssl')">
                                                SSL
                                                <span class="pf-c-select__menu-item-icon" v-if="settings.mail_encryption === 'ssl'">
                                                    <i class="fas fa-check" aria-hidden="true"></i>
                                                </span>
                                            </button>
                                        </li>
                    ...
                    <div class="pf-c-form__group" v-if="settings.mail_authcheck">
                        ...
                        <div class="pf-c-form__group-control">
                            <input
                                ...
                                tabindex="7"
                            />
                            <p v-if="emailSettings.errors.mail_username" class="pf-c-form__helper-text pf-m-error" id="form-help-text-address-helper" aria-live="polite">
                    ...
                    <div class="pf-c-form__group" v-if="settings.mail_authcheck">
                        ...
                        <div class="pf-c-form__group-control">
                            <input
                                ...
                                tabindex="8"
                            />
                            <p v-if="emailSettings.errors.mail_password" class="pf-c-form__helper-text pf-m-error" id="form-help-text-address-helper" aria-live="polite">
                    ...
                    <div class="pf-c-form__group pf-m-action">
                        <div class="pf-c-form__group-control">
                            <div class="pf-c-form__actions">
                                <button class="pf-c-button pf-m-primary" type="submit" @click.prevent="updateEmail" tabindex="9">Save</button>
                                <button
                                    ...
                                    tabindex="10"
                                >
                                    <span class="pf-c-button__progress" v-if="emailSettings.test1Loading">
                                ...
                                <button
                                    ...
                                    tabindex="11"
                                >
                                    <span class="pf-c-button__progress" v-if="emailSettings.test2Loading">
                                        <span class="pf-c-spinner pf-m-md" role="progressbar" aria-label="Loading...">
                                            <span class="pf-c-spinner__clipper"></span>
                                            <span class="pf-c-spinner__lead-ball"></span>
                                            <span class="pf-c-spinner__tail-ball"></span>
                            ...
                            <helper-success-text :show="emailSettings.isSuccess" :message="emailSettings.successMsg" style="margin-top: 10px"></helper-success-text>
                            <helper-error-text :show="emailSettings.isError" :message="emailSettings.errorMsg" style="margin-top: 10px"></helper-error-text>
                        </div>
                    </div>
                </form>
            </div>
