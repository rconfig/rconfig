<template>
    <div class="pf-c-card" style="margin-top: 18px">
        ...
        <table class="pf-c-table pf-m-compact pf-m-grid-lg" role="grid">
            <thead>
                <tr role="row">
                    <th role="columnheader" scope="col">Command</th>
                    <th role="columnheader" scope="col">Filename</th>
                    <th role="columnheader" scope="col">Downloaded</th>
                    <th class="pf-c-table__icon" role="columnheader" scope="col">Status</th>
            ...
            <tbody role="rowgroup">
                <tr role="row" v-for="latestConfig in latestConfigs.data" :key="latestConfig.id">
                    <th lass="pf-m-break-word" role="columnheader" data-label="Command">
