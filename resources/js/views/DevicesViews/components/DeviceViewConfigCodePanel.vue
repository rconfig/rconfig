    ...
    <div class="pf-c-card">
        <div class="pf-c-card__header pf-l-flex">
            ...
            <div class="pf-c-check pf-l-flex__item pf-m-align-right">
                <input class="pf-c-check__input" type="checkbox" id="darkmode" name="darkmode" @change="toggleEditorDarkMode($event)" :checked="darkmode == 'vs-dark'" style="margin-left: 0.5rem" />

                <label class="pf-c-check__label" style="cursor: default; color: #6a6e73"><small>Dark Mode</small></label>
            </div>
            <div class="pf-c-check" style="align-content: center">
                ...
                <label class="pf-c-check__label pf-u-hidden pf-u-display-inline-block-on-md" style="cursor: default; color: #6a6e73"><small>Line Numbers</small></label>
            </div>
            <div class="pf-c-check" style="align-content: center">
                <input
                    class="pf-c-check__input pf-u-hidden pf-u-display-inline-block-on-md"
                    ...
                    style="margin-left: 0.5rem"
                />
                <label class="pf-c-check__label pf-u-hidden pf-u-display-inline-block-on-md" style="cursor: default; color: #6a6e73"><small>Minimap</small></label>
            </div>
        </div>
            ...
            <div class="pf-c-code-editor">
                <div class="pf-c-code-editor__header">
                    <div class="pf-c-code-editor__controls">
                        ...
                        <button class="pf-c-button pf-m-control pf-u-hidden pf-u-display-inline-block-on-md" type="button" title="full screen" alt="full screen" @click="showConfigFullScreen">
                ...
                <div class="pf-c-code-editor__main" id="pf-c-code-editor__main">
                    <code class="pf-c-code-editor__code">
                        <div class="pf-c-code-editor__code-pre" id="pf-c-code-editor__code-pre" style="height: 80vh"></div>
                    </code>
                </div>
            </div>
        </div>
