<template>
    <main class="pf-c-page__main" tabindex="-1">
        <page-header :pagename="pagename">
            <template v-slot:breadcrumbs> <devices-breadcrumbs :devicename="model.device_name" :deviceId="model.id"></devices-breadcrumbs></template>
        </page-header>
                ...
                <div class="pf-c-drawer__main">
                        ...
                        <div class="pf-c-drawer__body pf-m-padding">
                            ...
                            <div class="pf-l-grid pf-m-gutter" v-if="!isLoading">
                                <div class="pf-l-grid__item pf-m-12-col pf-m-3-col-on-md">
                                    <device-view-device-details :model="model" @openDrawer="openDrawer($event)"> </device-view-device-details>
                                </div>
                                <div class="pf-l-grid__item pf-m-12-col pf-m-6-col-on-md">
                                    <device-view-status-panel :model="model"></device-view-status-panel>
                    ...
                    >
                        <template v-slot:form>
                            <devices-form :viewstate="viewstate" @closeDrawer="closeDrawer()" @formsubmitted="formSubmittedDeviceView($event)" :key="viewstate.sideDrawerComponentKey"></devices-form>
                        </template>
                    </side-drawer>
                </div>
            </div>
