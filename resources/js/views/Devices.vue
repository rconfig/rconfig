<template>
            ...
            <div class="pf-c-drawer" :class="{ 'pf-m-expanded': viewstate.openDrawerState }">
                <div class="pf-c-drawer__main">
                    ...
                    <data-table-devices
                        ...
                        @showEditColumnsModal="showEditColumnsModal = true"
                    ></data-table-devices>
                    <side-drawer
                        :pagename="viewstate.pagenamesingle"
                    ...
                    >
                        <template v-slot:form>
                            <devices-form :viewstate="viewstate" @closeDrawer="closeDrawer()" @formsubmitted="formSubmitted($event)" :key="viewstate.sideDrawerComponentKey"></devices-form>
                        </template>
                    </side-drawer>
                </div>
            </div>
    ...
    <modal-device-column-select v-if="showEditColumnsModal" @close="showEditColumnsModal = false" :rows="table.headers" @saveColumns="saveColumns"></modal-device-column-select>
</template>
